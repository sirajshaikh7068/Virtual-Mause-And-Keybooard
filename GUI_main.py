...
root.title("Gesture Recognition using Mouse and keyboard  ")
...
#
label_l1 = tk.Label(root, text="Gesture Recognition using Mouse and keyboard",font=("Times New Roman", 25, 'bold'),
